  ...
  return (
    <div className='my-10 pb-16'>
        <div className='flex items-center relative'>
            ...
            <div className={` ${isHovered ? 'opacity-100 duration-300  transition-all ':'opacity-0'}  absolute right-30 lg:right-72  top-30  lg:top-80 text-center flex flex-col gap-y-4`}>
