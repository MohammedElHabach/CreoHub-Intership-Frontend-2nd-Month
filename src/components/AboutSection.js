    ...
    <section id='about'>
        <div className='xl:container mx-auto  px-12 mt-10 '>
            <div className={`flex flex-col-reverse   ${rightPos ? 'md:flex-row':'md:flex-row-reverse'}   items-center relative`}>
                ...
                <h1 className={`text-xl md:text-2xl text-center  md:text-start whitespace-pre-line md:absolute  ${rightPos} ${leftPos}  `}>{text}<span className='text-red-500'>{span}</span></h1>
            </div>
        </div>
