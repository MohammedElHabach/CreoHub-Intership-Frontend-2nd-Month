  ...
  return (
    <div className='my-20 pb-44'>
        <div className='flex items-center relative'>
            ...
            <div className={` ${isHovered ? 'opacity-100 duration-300  transition-all ':'opacity-0'}  absolute right-30 lg:right-72  top-40  lg:top-80 lg:text-center space-y-4`}>
                ...
                <h2 className='lg:text-2xl font-bold'>+971 6 999 999 <br /> HelloDubai@headspace.com</h2>
            </div>
        </div>
